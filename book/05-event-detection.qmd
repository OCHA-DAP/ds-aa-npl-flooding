...
- **Chatara**: GEOGloWS matches 1 of 9 DHM crossings, with 42 false alarms. SFDC correction lowers the threshold but the matched count stays at 1; false alarms rise to 45. GloFAS matches 2 of 9 with 33 false alarms. GRRR matches a small number with a comparable false-alarm rate (see table).
- **Chisapani**: GEOGloWS matches **0 of 7** DHM crossings. SFDC correction does not change the matched count. GloFAS matches 5 of 7 with 95 false alarms.

**At RP5:**

- **Chatara**: GEOGloWS matches 1 of 9; GloFAS matches 1 of 9. False-alarm rates are similar.
- **Chisapani**: GEOGloWS matches 0 of 7; GloFAS matches 1 of 7.
...
GEOGloWS does not improve on GloFAS at any cell of this table. SFDC correction does not rescue it.
